...
PROCESO DE INSTALACIÓN 2
	Cambiar el usuario y la contraseña del archivo ubicado en la ruta /php/instalacion/ , agregar un usuario con permisos suficientes para crear base de datos y tablas.
